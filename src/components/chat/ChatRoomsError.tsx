...
interface ChatRoomsErrorProps {
    onRetry: () => void;
}

export default function ChatRoomsError({onRetry}: ChatRoomsErrorProps) {
    return (
        <Card className={"max-w-md mx-auto my-10 bg-card border-2 border-destructive shadow-lg"}>
            <CardBody className={"flex flex-col items-center p-8"}>
                ...
                <p className={"text-muted-foreground text-center mb-6"}>
                    We couldn't retrieve your chat list. This might be due to a network connection issue or a temporary server problem.
                </p>
