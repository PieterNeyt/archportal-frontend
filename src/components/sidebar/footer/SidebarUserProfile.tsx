...
export default function SidebarUserProfile({isOpen, dropdownOpen, setDropdownOpen}: SidebarUserProfileProps) {
    ...
    const activeColor = React.useMemo(() => {
        if (!loggedInUser?.activeUsernameColorId || !allBenefits) return undefined;
        return allBenefits.find(b => b.id === loggedInUser.activeUsernameColorId)?.configuration;
    }, [loggedInUser, allBenefits]);
