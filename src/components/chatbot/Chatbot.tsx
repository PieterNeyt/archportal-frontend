...
export default function FloatingAssistant() {
    ...
    return (
        <div className={"fixed bottom-1/3 right-6 z-50 flex flex-col items-end gap-4"}>
            {isOpen && (
                <>
                    <div
                    ...
                    <Card
                        ...
                        <CardHeader
                            className={"flex justify-between items-center bg-white/5 p-4 border-b border-white/10"}>
